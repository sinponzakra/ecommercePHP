	        	...
	        	<div class="col-sm-9">
		            ...
		            <div class="row">
		            	...
		            	<div class="col-sm-6">
		            		...
		            		<h3><b> <?php echo number_format($product['price'], 2).' MAD'; ?></b></h3>
		            		<p><b>Catégorie:</b> <a href="category.php?category=<?php echo $product['cat_slug']; ?>"><?php echo $product['catname']; ?></a></p>
		            		<p><b>Description:</b></p>
