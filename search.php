	      ...
	      <section class="content">
	        <div class="row">
	            ...
	            <?php
	       			...
	       			$row = $stmt->fetch();
	       			if($row['numrows'] < 1){
	       				echo '<h1 class="page-header">Aucun résultat trouvé pour <i>'.$_POST['keyword'].'</i></h1>';
	       			}
	       			else{
	       				echo '<h1 class="page-header">Résultats de recherche pour <i>'.$_POST['keyword'].'</i></h1>';
		       			try{
		       			 	$inc = 3;	
	       							...
	       							<div class='col-sm-4'>
	       								<div class='box box-solid'>
		       								...
		       								<div class='box-footer'>
		       									<b>".number_format($row['price'], 2)." MAD</b>
		       								</div>
	       								</div>
	       							</div>
	       						";
