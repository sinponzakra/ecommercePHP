<header class="main-header">
  ...
  <a href="#" class="logo">
    ...
    <span class="logo-lg"><b>Mega</b>Tech</span>
  </a>
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-header">
              ...
              <p>
                ...
                <small>Membre depuis <?php echo date('M. Y', strtotime($admin['created_on'])); ?></small>
              </p>
            </li>
            <li class="user-footer">
              <div class="pull-left">
                <a href="#profile" data-toggle="modal" class="btn btn-default btn-flat" id="admin_profile">Mettre à jour</a>
              </div>
